...
import { TUNGGAKAN_BUCKETS } from '../../data/potensiPenagihan.js'

export const DEFAULT_POTENSI_FILTERS = {
  kecamatan: 'Semua',
  kelurahan: 'Semua',
  jenis: 'Semua',
  tunggakan: 'Semua',
...
export default function PotensiFilterBar({ onApply }) {
  const [draft, setDraft] = useState(DEFAULT_POTENSI_FILTERS)
  ...
  function handleReset() {
    setDraft(DEFAULT_POTENSI_FILTERS)
    onApply(DEFAULT_POTENSI_FILTERS)
  }
